...
`8b  d8' 88      88      88booo.   .88.   88  V888 88.     
 `Y88P'  YP      YP      Y88888P Y888888P VP   V8P Y88888P ''' + W)
	print('\n' + G + '[-]' + C + ' Created By : ' + W + 'Johnny')
	print(G + '[-]' + C + ' Version    : ' + W + version + '\n')

def ver_check():
	print(G + '[+]' + C + ' TEST ', end='')
	ver_url = 'https://raw.githubusercontent.com/DeprivedJustice/offline/version.txt'
	try:
...
def tunnel_select():
	if tunnel_mode == None:
		...
		print(G + '[+]' + C + ' Start your own tunnel service manually ' + W + '\n')
	else:
...
def wait():
	...
	while True:
		...
		if size == 0 and printed == False:
			print('\n' + G + '[+]' + C + ' Waiting for someone to fuck up!' + W + '\n')
			printed = True
		if size > 0:
			main()
